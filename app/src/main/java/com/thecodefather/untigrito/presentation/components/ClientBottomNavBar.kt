        ...
        NavigationBarItem(
            ...
            icon = {
                Icon(
                    ...
                    tint = if (currentRoute == Routes.CLIENT_HOME) Color.White else Color.Gray
                )
            },
            ...
            colors = NavigationBarItemDefaults.colors(
                ...
                indicatorColor = Color(0xFFE67822)
            )
        )
        NavigationBarItem(
            ...
            icon = {
                Icon(
                    ...
                    tint = if (currentRoute == Routes.CLIENT_SERVICES) Color.White else Color.Gray
                )},
        ...
        NavigationBarItem(
            ...
            icon = {
                Icon(
                    ...
                    tint = if (currentRoute == Routes.CLIENT_REQUESTS) Color.White else Color.Gray
                )},
        ...
        NavigationBarItem(
            ...
            icon = {
                Icon(
                    ...
                    tint = if (currentRoute == Routes.CLIENT_PROFILE) Color.White else Color.Gray
                )},
